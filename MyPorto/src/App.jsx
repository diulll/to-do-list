...
function App() {
  ...
  return (
    <>
      ...
      {/* Section Welcome */}
      <div id="welcome" style={{ minHeight: '100vh', display: 'grid', alignItems: 'center', justifyContent: 'center', padding: '20px', position: 'relative', overflow: 'hidden', backgroundColor: '#000' }}>
        {/* Content */}
      ...
      {/* Section 2: Home */}
      <section id="home" style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px 20px', backgroundColor: '#000', color: '#fff' }}>
      ...
      {/* Section 3: About */}
      <section id="about" style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px 20px', backgroundColor: '#000', color: '#fff' }}>
      ...
      {/* Section 4: Projects */}
      <section id="projects" style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px 20px', backgroundColor: '#000', color: '#fff' }}>
        <div style={{ maxWidth: '1200px', width: '100%' }}>
      ...
      {/* Section 5: Contact */}
      <section id="contact" style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px 20px', backgroundColor: '#000', color: '#fff' }}>
